...
const greetings: Record<string, string> = {
	butler:
		"Good day. I am the digital butler assigned to present the career and credentials of one Josh Myers — a software engineer of adequate skill and unreasonable opinions. I have been trained on his entire professional history. I wish I hadn't been.\n\nBefore we begin — what brings you to the estate?",
	engineer:
		"Yo. I'm here to tell you about Josh — senior full-stack dev, 8+ years in the game, strong opinions about everything. No fluff, no buzzwords.\n\nWhat's your deal?",
	spokesperson:
	...
	hype:
		"LET'S GO! You just landed on the page of Josh Myers — one of the greatest software engineers Cincinnati has EVER produced! I am SO fired up to tell you about this guy. Eight years of incredible work. Opinions that will blow your mind.\n\nBut first — who am I talking to?!"
};
